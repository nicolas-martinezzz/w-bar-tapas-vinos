...
import { restaurant, openingHours, socialLinks } from "@/config/restaurant"
    ...
    <footer className="bg-black text-white py-12 border-t border-white/10">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            ...
            <div className="flex space-x-4">
              <Link href={socialLinks.instagram.href} target="_blank" rel="noopener noreferrer" className="text-[#C4A962] hover:text-[#D4BC7B] transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-2 text-[#8C8C8C]">
              {openingHours.map(h => (
                <li key={h.days}>{h.days} de {h.hours}</li>
              ))}
            </ul>
          </div>
          ...
          <div>
            ...
            <address className="not-italic text-[#8C8C8C] space-y-2">
              ...
              <p>{restaurant.neighborhood}, {restaurant.country}</p>
        ...
        <div className="border-t border-white/10 mt-8 pt-8 text-center text-[#8C8C8C]">
          <p>&copy; {new Date().getFullYear()} {restaurant.name} de vinos y tapas. Todos los derechos reservados.</p>
